...
*Griffe TypeDoc* follows the **sponsorware** release strategy, which means
...
*Griffe TypeDoc Insiders* is a private fork of *Griffe TypeDoc*, hosted as
...
repository.
  ...
  [^1]:
    ...
    existing features that must be supported by *Griffe TypeDoc*.
...
*Griffe TypeDoc* and released for general availability, making them available
...
The biggest bottleneck in Open Source is time.[^3]
  ...
  [^3]:
    ...
    The sponsorware model ensures that if you decide to use *Griffe TypeDoc*,
...
<small>
  ...
  your profile and avatar to show your support for *Griffe TypeDoc*.
...
to use *Griffe TypeDoc* locally without having access to Insiders.
Is this still possible?

Yes. Insiders is compatible with *Griffe TypeDoc*. Almost all new features
...
Yes. Whether you're an individual or a company, you may use *Griffe TypeDoc
Insiders* precisely under the same terms as *Griffe TypeDoc*, which are given
